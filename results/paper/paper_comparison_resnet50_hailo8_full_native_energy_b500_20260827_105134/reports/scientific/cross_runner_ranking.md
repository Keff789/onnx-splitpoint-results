...
Candidate pairs: **0**; technical: **0**, quality: **0**, claim: **0**
Planned Native intersection: **0/0**; Generic rows outside this denominator: **1**
Legacy normalized endpoint defaults reconciled by exact central request projection: **0**
Qualified technical micro-concordance: **0/0** (None); Hit@1: **0/0**; Regret@1 median: **None**
