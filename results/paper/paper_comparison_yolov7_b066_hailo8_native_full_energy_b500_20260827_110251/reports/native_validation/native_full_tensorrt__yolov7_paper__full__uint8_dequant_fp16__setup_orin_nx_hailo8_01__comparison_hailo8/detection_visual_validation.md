...
Semantic: `True`  match_ratio=1.000 matched=9/9 pred=10

Class-agnostic IoU: match_ratio=1.000 matched=9/9
...
|---|---|---|---:|---:|---:|---|
| `output` | `[1, 3, 80, 80, 85]` | `float32` | -29.375 | 9.203125 | -7.460124969482422 | `detection_scoremap_00_output.png` |
| `clone_1` | `[1, 3, 40, 40, 85]` | `float32` | -30.796875 | 9.6875 | -7.728445529937744 | `detection_scoremap_01_clone_1.png` |
| `clone_2` | `[1, 3, 20, 20, 85]` | `float32` | -20.203125 | 8.640625 | -8.421255111694336 | `detection_scoremap_02_clone_2.png` |
